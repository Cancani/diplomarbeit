...
!!! info "Lesehinweis"
    Diese Dokumentation entsteht laufend während der Projektlaufzeit vom 14.09.2026 bis 18.12.2026.
...
> Wird am Projektende verfasst und zusätzlich als separates Dokument mit unterschriebenem Ehrenwort abgegeben.
...
#### 2.1.1 Ausgangspunkt als "magisches Dreieck"
...
Daraus folgt die zentrale Steuerungsregel dieses Projekts: Bei Abweichungen wird der Umfang reduziert.
...
| Betriebsorganisation und Übergabe | Vorschlag für die Zuständigkeiten im Weiterbetrieb, abgestimmt mit beiden Experten | Kapitel 2.2.1 und 6 |
...
#### 2.2.1 Zuständigkeiten für einen möglichen Weiterbetrieb

Die Rollen in der obigen Matrix gelten für die **Projektlaufzeit**. Für die Zeit danach ist heute nicht geklärt, wer die Lösung betreiben, weiterentwickeln und unterstützen würde. Das ist keine Nachlässigkeit, sondern eine reale organisatorische Lücke, die diese Arbeit sichtbar macht.

Die Ausgangslage dazu: Die Laborinfrastruktur des HF-Labors liegt nicht in der Verantwortung des Informatikdienstes, sondern bei der HF-Weiterbildung. Der Informatikdienst ist Auftraggeber dieser Arbeit, betreibt die betroffenen Systeme aber nicht. Eine spätere Betriebsübernahme durch den Informatikdienst ist deshalb nicht selbstverständlich, sondern müsste ausdrücklich vereinbart werden.

**Ergebnis dieser Arbeit ist deshalb auch ein Vorschlag, wer künftig für was zuständig wäre.** Die folgende Matrix wird im Verlauf des Projekts gefüllt und in der dritten Zwischenpräsentation mit beiden Experten abgestimmt. Sie ist Teil der Beurteilung der Übertragbarkeit in Kapitel 6 und Grundlage des Runbooks in Kapitel 7.

| Aufgabe im Weiterbetrieb | Vorschlag Zuständigkeit | Begründung | Abgestimmt |
| --- | --- | --- | --- |
| Betrieb der Zielplattform, also Cluster und Virtualisierung | | | Offen |
| Pflege des Fachmodells und des Schemas | | | Offen |
| Anlegen und Abbauen von Lernumgebungen im Unterricht | | | Offen |
| Weiterentwicklung des Agenten und der Adapter | | | Offen |
| Verwaltung der Cloud-Zugänge und der Kosten | | | Offen |
| Unterstützung bei Störungen während des Unterrichts | | | Offen |
| Sicherheit, Berechtigungen und Datenschutz | | | Offen |

Ohne diese Klärung bliebe der Proof of Concept technisch erfolgreich, aber organisatorisch nicht anschlussfähig. Ein Ergebnis, für das sich niemand zuständig fühlt, wird nicht weiterverwendet.
...
| --- | --- | --- | --- | --- | --- |
| HF-Weiterbildung TBZ, vertreten durch Thanam Pangri als Schulexperte | Bewertung, methodische Begleitung, Betrieb der Lernumgebungen im Unterricht | Hoch | Hoch | Methodisch sauberes Vorgehen, nachvollziehbare Dokumentation, klar herausgearbeiteter Mehrwert von MCP, anschlussfähiges Ergebnis für den Lehrbetrieb | Technische Tiefe gegen methodische Vollständigkeit |
| Informatikdienst TBZ, vertreten durch Kuno Vogt als Firmenexperte | Auftraggeber, Firmenexperte, direkter Vorgesetzter des Diplomanden | Hoch | Hoch | Belastbare Entscheidungsgrundlage, kein Eingriff in den produktiven Betrieb, klare Zuständigkeiten für einen möglichen Weiterbetrieb | Die Projektarbeit darf das Tagesgeschäft nicht belasten. Die Laborinfrastruktur liegt nicht beim Informatikdienst, eine spätere Betriebsübernahme ist deshalb nicht selbstverständlich |
| Dozierende der HF, insbesondere der Module m239, m254 und m426 | Fachliche Auskunft, spätere Nutzende | Mittel | Niedrig | Lernumgebungen müssen fachlich das Gleiche leisten wie heute | Eine reduzierte Test-Lernumgebung könnte als Abwertung ihrer Module gelesen werden |
...
quadrantChart
    ...
    "Informatikdienst TBZ": [0.82, 0.80]
    "Dozierende HF": [0.62, 0.30]
    "Lernende": [0.30, 0.15]
```
...
| --- | --- | --- |
| Eng einbinden: HF-Weiterbildung und Informatikdienst, vertreten durch die beiden Experten | Aktiv einbeziehen, Entscheide gemeinsam absichern | Drei Zwischenpräsentationen als Sprint Reviews, wöchentlicher Statusbericht, Change Requests mit Zustimmung beider Experten. Die Abgrenzung des Umfangs wird beim Kickoff ausdrücklich bestätigt. Die Zuständigkeitsfrage nach Kapitel 2.2.1 wird bis zur dritten Zwischenpräsentation geklärt |
| Informiert halten: Dozierende der HF | Fachlich konsultieren, Erwartungen klären | Bei der Ableitung der Test-Lernumgebung in US08 konsultieren, Abgrenzung des Proof of Concept aktiv erklären |
...
1. Sprintziel und was daraus wurde
2. Abgleich gegen die Zieltabelle aus Kapitel 1.4
3. Demo des lauffähigen Standes
4. Herausforderungen, Entscheide und Abweichungen
5. Risikolage und Ausblick auf den nächsten Sprint
6. Fragen und Rückmeldung der Experten
...
- [ ] Bereitstellungszeit und Anzahl manueller Eingriffe sind erfasst
...
| Sprint 3, 5 Wochen | 41 Story Points | 5 mal 8, plus 1 Punkt aus der nachträglich aufgenommenen Zuständigkeitsklärung |
| Gesamtbudget | 113 Story Points | Entspricht dem Umfang des Product Backlogs |
